...
pub struct DeleteTableBucketResult {
...
impl Client {
    ...
    pub async fn delete_table_bucket(
    ...
    ) -> Result<DeleteTableBucketResult, Box<dyn std::error::Error + Send + Sync>> {
        let mut input = OperationInput {
            op_name: "DeleteTableBucket".to_string(),
        ...
        let mut result = DeleteTableBucketResult::default();
...
mod tests {
    ...
    #[test]
    fn test_delete_table_bucket_request_keeps_arn_out_of_the_query() {
        let request = DeleteTableBucketRequest {
